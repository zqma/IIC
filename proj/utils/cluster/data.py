...
from proj.datasets.clustering.truncated_dataset import TruncatedDataset
from proj.utils.cluster.transforms import sobel_make_transforms, \
    greyscale_make_transforms
from proj.utils.semisup.dataset import TenCropAndFinish
...
def create_basic_clustering_dataloaders(config):
    """
    My original data loading proj is complex to cover all my experiments. Here is a simple version.
